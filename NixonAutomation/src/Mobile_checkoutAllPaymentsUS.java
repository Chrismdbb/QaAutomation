/*
 * 
 * import java.awt.Desktop.Action; import java.util.concurrent.TimeUnit;
 * 
 ...
 * String Lname = " Automation Test"; String USadd = "3668 Harvard Drive";
 * String UScity = "oceanside"; String Pcode = "92056"; String Phone =
 * "7604056763";
 * 
 * String[] Payment; Payment = new String[6];
 * 
 * Payment[0] = "Visa"; Payment[1] = "MasterCard"; Payment[2] =
 * "American Express"; Payment[3] = "Discover"; Payment[4] = "Paypal";
 * Payment[5] = "AfterPay";
 * 
 * String Urls = "https://storefront:nix2015@stg.nixon.com/us/en";
 * 
 * for (int i = 0; i < Payment.length; i++) { MobileTestiPhone(Urls);
 * 
 ...
 * isDisplayed()) { // if the tag // options // is not displayed
 * driver.findElement(By.className("modal-close")).click(); }
 * 
 ...
 * cssSelector("body > div.main > section.view-section.ng-scope > section > form > div > payment-schedule > section > due-today > section > div > div.modal-payment-up-front.hide-outline.ng-scope > button"
 * )).click();
 * 
 * 
 * wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(
 ...
 * 
 * 
 * Takescreenshots("Nixon.Mobile.CheckoutAllPayments", "US_STG_Orders",
 * Payment[i]);
 * 
 * quitbrowser(); }
 * 
